...
import DynamicLayout from '@hasty-bazar-commerce/layout/DynamicLayout'
...
const ProductPage = (props: ProductPageProps) => {
  ...
  const activeUniqueProduct = productDetail?.data?.uniqueProducts?.find((_) => _.hsin === hsin)
...
ProductPage.layout = ({ children }: any) => <>{children}</>
