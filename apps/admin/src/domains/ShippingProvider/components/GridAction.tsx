...
import {
  saleApi,
  usePostAdminSaleApiShippingProvidersChangeStateMutation,
...
const GridAction: FC<IGridActionType> = ({ onDelete, onEdit, gridRef, ...props }) => {
  ...
  return (
    <GridWorkflowActionColumn
      ...
      factor="1"
      stateMachineCode={StateMachineCode.ShippingProvider.toString()}
      useChangeState={usePostAdminSaleApiShippingProvidersChangeStateMutation}
      useLazyGetStateList={
        saleApi.useLazyGetAdminSaleApiShippingProvidersGetTransitionByEntityIdAndStateMachineCodeFactorQuery
      }
      {...props}
      menuItems={[
        {
