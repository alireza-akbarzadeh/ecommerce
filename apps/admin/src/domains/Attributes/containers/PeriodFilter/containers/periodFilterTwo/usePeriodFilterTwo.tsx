...
const usePeriodFilterTwo = ({
  ...
  const actionUrl = `${process.env.NEXT_PUBLIC_GATEWAY}/Admin/Catalog/api/AttributeFilter/${attributeId}/Childs`
  ...
  const columnDefs = useMemo(
    () =>
      [
        ...
        {
          field: 'name',
          headerName: formatMessage(periodFilter.filter2Title),
          filter: 'agTextColumnFilter',
          maxWidth: 450,
