...
export default function DisplayExtractTypeCode({ disabled, data }: Props) {
  ...
  return (
    <HBAutocompleteController
      ...
      label={formatMessage(ProductGroupPageMessages.displayExtract)}
      fieldName={'displayExtractTypeCode'}
